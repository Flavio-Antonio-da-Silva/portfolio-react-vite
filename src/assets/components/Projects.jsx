...
export default function Projects() {
  ...
  return (
    <section
      id="projetos"
      className="w-full bg-gradient-to-r from-indigo-500 text-gray-900 rounded-md 
                 transform transition-all duration-700 ease-out mb-8"
    >
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-20 mt-20">
        <h2
          id="projects-title"
          className="text-3xl md:text-4xl text-blue-100 font-bold tracking-tight mb-10 text-center"
        >
          Projetos
        </h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative z-10 text-white">
                ...
                <p className="mb-4 text-sm md:text-base leading-relaxed drop-shadow-md">
                  {project.description}
                </p>
              </div>
